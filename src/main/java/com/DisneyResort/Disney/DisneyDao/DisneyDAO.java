...
public class DisneyDAO implements IDisneyDAO {
	...
	//------------------------UPDATE DAO-----------------------------//
	   ...
	   //------------------------DELETE DAO-----------------------------//		
		@Override
		public void cancelresort(int id) {
			String sql="delete from resort_reservation where guest_id_fk=?";
			Object[] param = {id};
			jdbcTemplate.update(sql, param);
		}

		@Override
		public void canceldining(int id) {
			String sql="delete from dining_reservation where guestid_fk=?";
			Object[] param = {id};
			jdbcTemplate.update(sql,param);
		}		
}
